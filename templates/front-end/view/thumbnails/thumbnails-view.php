            ...
            <li class="huge_it_big_li">
                    ...
                    <div class="huge_it_gallery_like_cont_<?php echo $galleryID . $pID; ?>">
                        <div class="huge_it_gallery_like_wrapper">
							<span class="huge_it_like">
								...
								<span
                                    class="huge_it_like_count <?php if ($paramssld['ht_thumb_rating_count'] == 'off') echo 'huge_it_hide'; ?>"
                        ...
                        <?php if ($like_dislike != 'heart'): ?>
							...
							<span
                                class="huge_it_dislike_count <?php if ($paramssld['ht_thumb_rating_count'] == 'off') echo 'huge_it_hide'; ?>"
                ...
                switch ($imagerowstype) {
                    case 'image':
                        ...
                        <img
                            src="<?php echo esc_url(gallery_img_get_image_by_sizes_and_src($row->image_url, array(get_option('thumb_image_width'), get_option('thumb_image_height')), false)); ?>"
